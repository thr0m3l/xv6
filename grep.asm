...
000001d0 <grep>:
{
 ...
 1fd:	50                   	push   %eax
 1fe:	8d 81 00 0f 00 00    	lea    0xf00(%ecx),%eax
 204:	50                   	push   %eax
 ...
 21b:	8b 4d dc             	mov    -0x24(%ebp),%ecx
    p = buf;
 21e:	c7 45 e4 00 0f 00 00 	movl   $0xf00,-0x1c(%ebp)
    buf[m] = '\0';
 225:	c6 81 00 0f 00 00 00 	movb   $0x0,0xf00(%ecx)
    while((q = strchr(p, '\n')) != 0){
 ...
 2bb:	81 fa 00 0f 00 00    	cmp    $0xf00,%edx
 ...
 2d0:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 2d3:	2d 00 0f 00 00       	sub    $0xf00,%eax
 2d8:	29 c1                	sub    %eax,%ecx
      memmove(buf, p, m);
 2da:	51                   	push   %ecx
 2db:	52                   	push   %edx
 2dc:	68 00 0f 00 00       	push   $0xf00
      m -= p - buf;
...
char *gets(char *buf, int max) {
 ...
 4a5:	57                   	push   %edi
 4a6:	6a 00                	push   $0x0
 4a8:	e8 4e 01 00 00       	call   5fb <read>
    if (cc < 1)
...
int stat(const char *n, struct stat *st) {
 ...
 50d:	e8 11 01 00 00       	call   623 <open>
  if (fd < 0)
 ...
 521:	50                   	push   %eax
 522:	e8 14 01 00 00       	call   63b <fstat>
  close(fd);
 527:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 52a:	89 c6                	mov    %eax,%esi
  close(fd);
 52c:	e8 da 00 00 00       	call   60b <close>
  return r;
...
int atoi(const char *s) {
 ...
 553:	56                   	push   %esi
 554:	be 01 00 00 00       	mov    $0x1,%esi
 ...
 55c:	53                   	push   %ebx
  ...
  nbr = 0;
  if (s[0] == '-') {
 55d:	0f b6 11             	movzbl (%ecx),%edx
 560:	80 fa 2d             	cmp    $0x2d,%dl
 563:	75 0c                	jne    571 <atoi+0x21>
    sign = -1;
    s++;
  }
  i = 0;
  while (s[i] >= '0' && s[i] <= '9' && s[i] != '\0') {
 565:	0f b6 51 01          	movzbl 0x1(%ecx),%edx
    sign = -1;
 569:	be ff ff ff ff       	mov    $0xffffffff,%esi
    s++;
 56e:	83 c1 01             	add    $0x1,%ecx
  while (s[i] >= '0' && s[i] <= '9' && s[i] != '\0') {
 571:	8d 5a d0             	lea    -0x30(%edx),%ebx
 574:	80 fb 09             	cmp    $0x9,%bl
 577:	77 2f                	ja     5a8 <atoi+0x58>
 579:	83 c1 01             	add    $0x1,%ecx
  val = 0;
 57c:	31 db                	xor    %ebx,%ebx
 57e:	66 90                	xchg   %ax,%ax
    nbr = (int)(s[i] - '0');
 580:	83 ea 30             	sub    $0x30,%edx
    val = (val * 10) + nbr;
 583:	8d 1c 9b             	lea    (%ebx,%ebx,4),%ebx
  while (s[i] >= '0' && s[i] <= '9' && s[i] != '\0') {
 586:	83 c1 01             	add    $0x1,%ecx
    nbr = (int)(s[i] - '0');
 589:	0f be d2             	movsbl %dl,%edx
    val = (val * 10) + nbr;
 58c:	8d 1c 5a             	lea    (%edx,%ebx,2),%ebx
  while (s[i] >= '0' && s[i] <= '9' && s[i] != '\0') {
 58f:	0f b6 51 ff          	movzbl -0x1(%ecx),%edx
 593:	8d 42 d0             	lea    -0x30(%edx),%eax
 596:	3c 09                	cmp    $0x9,%al
 598:	76 e6                	jbe    580 <atoi+0x30>
    i++;
  }
  i++;
  return (val * sign);
 59a:	89 f0                	mov    %esi,%eax
 59c:	0f af c3             	imul   %ebx,%eax
}
 59f:	5b                   	pop    %ebx
 5a0:	5e                   	pop    %esi
 5a1:	5d                   	pop    %ebp
 ...
 6cc:	89 d1                	mov    %edx,%ecx
{
 ...
 73e:	56                   	push   %esi
 73f:	57                   	push   %edi
 740:	e8 be fe ff ff       	call   603 <write>
  while(--i >= 0)
 ...
 779:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7b5:	57                   	push   %edi
 7b6:	56                   	push   %esi
 7b7:	e8 47 fe ff ff       	call   603 <write>
 ...
 80e:	e8 f0 fd ff ff       	call   603 <write>
        putc(fd, c);
 ...
 8cc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 8cf:	e8 2f fd ff ff       	call   603 <write>
        ap++;
...
free(void *ap)
{
 ...
 911:	a1 00 13 00 00       	mov    0x1300,%eax
{
 ...
 951:	5b                   	pop    %ebx
  freep = p;
 952:	89 15 00 13 00 00    	mov    %edx,0x1300
}
 958:	5e                   	pop    %esi
 959:	5f                   	pop    %edi
 95a:	5d                   	pop    %ebp
 ...
 989:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 98c:	89 15 00 13 00 00    	mov    %edx,0x1300
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9ac:	8b 3d 00 13 00 00    	mov    0x1300,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9ef:	73 4f                	jae    a40 <malloc+0xa0>
    ...
    if(p == freep)
 9f1:	8b 3d 00 13 00 00    	mov    0x1300,%edi
 ...
 a03:	e8 63 fc ff ff       	call   66b <sbrk>
  if(p == (char*)-1)
 ...
 a1a:	e8 f1 fe ff ff       	call   910 <free>
  return freep;
 a1f:	8b 15 00 13 00 00    	mov    0x1300,%edx
 ...
 a4c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a4f:	89 15 00 13 00 00    	mov    %edx,0x1300
}
 ...
 a5f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a60:	c7 05 00 13 00 00 04 	movl   $0x1304,0x1300
 a67:	13 00 00 
    base.s.size = 0;
 a6a:	bf 04 13 00 00       	mov    $0x1304,%edi
    base.s.ptr = freep = prevp = &base;
 a6f:	c7 05 04 13 00 00 04 	movl   $0x1304,0x1304
 a76:	13 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a79:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a7b:	c7 05 08 13 00 00 00 	movl   $0x0,0x1308
 a82:	00 00 00 
    if(p->s.size >= nunits){
