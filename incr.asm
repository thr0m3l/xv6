...
int main(int argc, char *argv[]) {
  ...
  1f:	e8 37 03 00 00       	call   35b <incr>
  24:	83 c4 0c             	add    $0xc,%esp
  27:	50                   	push   %eax
  28:	68 68 07 00 00       	push   $0x768
  2d:	6a 01                	push   $0x1
  2f:	e8 0c 04 00 00       	call   440 <printf>
  exit();
...
char *gets(char *buf, int max) {
 ...
 175:	57                   	push   %edi
 176:	6a 00                	push   $0x0
 178:	e8 4e 01 00 00       	call   2cb <read>
    if (cc < 1)
...
int stat(const char *n, struct stat *st) {
 ...
 1dd:	e8 11 01 00 00       	call   2f3 <open>
  if (fd < 0)
 ...
 1f1:	50                   	push   %eax
 1f2:	e8 14 01 00 00       	call   30b <fstat>
  close(fd);
 1f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1fa:	89 c6                	mov    %eax,%esi
  close(fd);
 1fc:	e8 da 00 00 00       	call   2db <close>
  return r;
...
int atoi(const char *s) {
 ...
 235:	0f b6 51 01          	movzbl 0x1(%ecx),%edx
    sign = -1;
 ...
 247:	77 2f                	ja     278 <atoi+0x58>
 249:	83 c1 01             	add    $0x1,%ecx
  val = 0;
 24c:	31 db                	xor    %ebx,%ebx
 24e:	66 90                	xchg   %ax,%ax
    nbr = (int)(s[i] - '0');
 250:	83 ea 30             	sub    $0x30,%edx
    val = (val * 10) + nbr;
 253:	8d 1c 9b             	lea    (%ebx,%ebx,4),%ebx
  while (s[i] >= '0' && s[i] <= '9' && s[i] != '\0') {
 256:	83 c1 01             	add    $0x1,%ecx
    nbr = (int)(s[i] - '0');
 259:	0f be d2             	movsbl %dl,%edx
    val = (val * 10) + nbr;
 25c:	8d 1c 5a             	lea    (%edx,%ebx,2),%ebx
  while (s[i] >= '0' && s[i] <= '9' && s[i] != '\0') {
 25f:	0f b6 51 ff          	movzbl -0x1(%ecx),%edx
 263:	8d 42 d0             	lea    -0x30(%edx),%eax
 266:	3c 09                	cmp    $0x9,%al
 268:	76 e6                	jbe    250 <atoi+0x30>
    i++;
  }
  i++;
  return (val * sign);
 26a:	89 f0                	mov    %esi,%eax
 26c:	0f af c3             	imul   %ebx,%eax
}
 26f:	5b                   	pop    %ebx
 270:	5e                   	pop    %esi
 271:	5d                   	pop    %ebp
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba 6c 07 00 00       	mov    $0x76c,%edx
        while(*s != 0){
 ...
 5e1:	a1 88 0a 00 00       	mov    0xa88,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 88 0a 00 00    	mov    %edx,0xa88
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 88 0a 00 00    	mov    %edx,0xa88
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d 88 0a 00 00    	mov    0xa88,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d 88 0a 00 00    	mov    0xa88,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 88 0a 00 00    	mov    0xa88,%edx
 ...
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf 8c 0a 00 00       	mov    $0xa8c,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 90 0a 00 00 00 	movl   $0x0,0xa90
 752:	00 00 00 
    if(p->s.size >= nunits){
