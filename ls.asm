...
char *gets(char *buf, int max) {
 ...
 475:	57                   	push   %edi
 476:	6a 00                	push   $0x0
 478:	e8 4e 01 00 00       	call   5cb <read>
    if (cc < 1)
...
int stat(const char *n, struct stat *st) {
 ...
 4dd:	e8 11 01 00 00       	call   5f3 <open>
  if (fd < 0)
 ...
 4f1:	50                   	push   %eax
 4f2:	e8 14 01 00 00       	call   60b <fstat>
  close(fd);
 4f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 4fa:	89 c6                	mov    %eax,%esi
  close(fd);
 4fc:	e8 da 00 00 00       	call   5db <close>
  return r;
...
int atoi(const char *s) {
 ...
 523:	56                   	push   %esi
 524:	be 01 00 00 00       	mov    $0x1,%esi
 ...
 535:	0f b6 51 01          	movzbl 0x1(%ecx),%edx
    sign = -1;
 539:	be ff ff ff ff       	mov    $0xffffffff,%esi
    s++;
 53e:	83 c1 01             	add    $0x1,%ecx
  while (s[i] >= '0' && s[i] <= '9' && s[i] != '\0') {
 541:	8d 5a d0             	lea    -0x30(%edx),%ebx
 544:	80 fb 09             	cmp    $0x9,%bl
 547:	77 2f                	ja     578 <atoi+0x58>
 549:	83 c1 01             	add    $0x1,%ecx
  val = 0;
 54c:	31 db                	xor    %ebx,%ebx
 54e:	66 90                	xchg   %ax,%ax
    nbr = (int)(s[i] - '0');
 550:	83 ea 30             	sub    $0x30,%edx
    val = (val * 10) + nbr;
 553:	8d 1c 9b             	lea    (%ebx,%ebx,4),%ebx
  while (s[i] >= '0' && s[i] <= '9' && s[i] != '\0') {
 556:	83 c1 01             	add    $0x1,%ecx
    nbr = (int)(s[i] - '0');
 559:	0f be d2             	movsbl %dl,%edx
    val = (val * 10) + nbr;
 55c:	8d 1c 5a             	lea    (%edx,%ebx,2),%ebx
  while (s[i] >= '0' && s[i] <= '9' && s[i] != '\0') {
 55f:	0f b6 51 ff          	movzbl -0x1(%ecx),%edx
 563:	8d 42 d0             	lea    -0x30(%edx),%eax
 566:	3c 09                	cmp    $0x9,%al
 568:	76 e6                	jbe    550 <atoi+0x30>
    i++;
  }
  i++;
  return (val * sign);
 56a:	89 f0                	mov    %esi,%eax
 56c:	0f af c3             	imul   %ebx,%eax
}
 56f:	5b                   	pop    %ebx
 570:	5e                   	pop    %esi
 571:	5d                   	pop    %ebp
 ...
 69c:	89 d1                	mov    %edx,%ecx
{
 ...
 70e:	56                   	push   %esi
 70f:	57                   	push   %edi
 710:	e8 be fe ff ff       	call   5d3 <write>
  while(--i >= 0)
 ...
 749:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 785:	57                   	push   %edi
 786:	56                   	push   %esi
 787:	e8 47 fe ff ff       	call   5d3 <write>
 ...
 7de:	e8 f0 fd ff ff       	call   5d3 <write>
        putc(fd, c);
 ...
 7ef:	57                   	push   %edi
 7f0:	56                   	push   %esi
 7f1:	e8 dd fd ff ff       	call   5d3 <write>
        putc(fd, c);
 ...
 85b:	57                   	push   %edi
 85c:	56                   	push   %esi
 85d:	e8 71 fd ff ff       	call   5d3 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 8e1:	a1 68 0e 00 00       	mov    0xe68,%eax
{
 ...
 921:	5b                   	pop    %ebx
  freep = p;
 922:	89 15 68 0e 00 00    	mov    %edx,0xe68
}
 928:	5e                   	pop    %esi
 929:	5f                   	pop    %edi
 92a:	5d                   	pop    %ebp
 ...
 959:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 95c:	89 15 68 0e 00 00    	mov    %edx,0xe68
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 979:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 97c:	8b 3d 68 0e 00 00    	mov    0xe68,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9bf:	73 4f                	jae    a10 <malloc+0xa0>
    ...
    if(p == freep)
 9c1:	8b 3d 68 0e 00 00    	mov    0xe68,%edi
 ...
 9d3:	e8 63 fc ff ff       	call   63b <sbrk>
  if(p == (char*)-1)
 ...
 9ea:	e8 f1 fe ff ff       	call   8e0 <free>
  return freep;
 9ef:	8b 15 68 0e 00 00    	mov    0xe68,%edx
 ...
 a1c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a1f:	89 15 68 0e 00 00    	mov    %edx,0xe68
}
 ...
 a2f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a30:	c7 05 68 0e 00 00 6c 	movl   $0xe6c,0xe68
 a37:	0e 00 00 
    base.s.size = 0;
 a3a:	bf 6c 0e 00 00       	mov    $0xe6c,%edi
    base.s.ptr = freep = prevp = &base;
 a3f:	c7 05 6c 0e 00 00 6c 	movl   $0xe6c,0xe6c
 a46:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a49:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a4b:	c7 05 70 0e 00 00 00 	movl   $0x0,0xe70
 a52:	00 00 00 
    if(p->s.size >= nunits){
