...
char *gets(char *buf, int max) {
 ...
 245:	57                   	push   %edi
 246:	6a 00                	push   $0x0
 248:	e8 4e 01 00 00       	call   39b <read>
    if (cc < 1)
...
int stat(const char *n, struct stat *st) {
 ...
 2ad:	e8 11 01 00 00       	call   3c3 <open>
  if (fd < 0)
 ...
 2c1:	50                   	push   %eax
 2c2:	e8 14 01 00 00       	call   3db <fstat>
  close(fd);
 2c7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2ca:	89 c6                	mov    %eax,%esi
  close(fd);
 2cc:	e8 da 00 00 00       	call   3ab <close>
  return r;
...
int atoi(const char *s) {
 ...
 2f3:	56                   	push   %esi
 2f4:	be 01 00 00 00       	mov    $0x1,%esi
 ...
 2fc:	53                   	push   %ebx
  ...
  nbr = 0;
  if (s[0] == '-') {
 2fd:	0f b6 11             	movzbl (%ecx),%edx
 300:	80 fa 2d             	cmp    $0x2d,%dl
 303:	75 0c                	jne    311 <atoi+0x21>
    sign = -1;
    s++;
  }
  i = 0;
  while (s[i] >= '0' && s[i] <= '9' && s[i] != '\0') {
 305:	0f b6 51 01          	movzbl 0x1(%ecx),%edx
    sign = -1;
 309:	be ff ff ff ff       	mov    $0xffffffff,%esi
    s++;
 30e:	83 c1 01             	add    $0x1,%ecx
  while (s[i] >= '0' && s[i] <= '9' && s[i] != '\0') {
 311:	8d 5a d0             	lea    -0x30(%edx),%ebx
 314:	80 fb 09             	cmp    $0x9,%bl
 317:	77 2f                	ja     348 <atoi+0x58>
 319:	83 c1 01             	add    $0x1,%ecx
  val = 0;
 31c:	31 db                	xor    %ebx,%ebx
 31e:	66 90                	xchg   %ax,%ax
    nbr = (int)(s[i] - '0');
 320:	83 ea 30             	sub    $0x30,%edx
    val = (val * 10) + nbr;
 323:	8d 1c 9b             	lea    (%ebx,%ebx,4),%ebx
  while (s[i] >= '0' && s[i] <= '9' && s[i] != '\0') {
 326:	83 c1 01             	add    $0x1,%ecx
    nbr = (int)(s[i] - '0');
 329:	0f be d2             	movsbl %dl,%edx
    val = (val * 10) + nbr;
 32c:	8d 1c 5a             	lea    (%edx,%ebx,2),%ebx
  while (s[i] >= '0' && s[i] <= '9' && s[i] != '\0') {
 32f:	0f b6 51 ff          	movzbl -0x1(%ecx),%edx
 333:	8d 42 d0             	lea    -0x30(%edx),%eax
 336:	3c 09                	cmp    $0x9,%al
 338:	76 e6                	jbe    320 <atoi+0x30>
    i++;
  }
  i++;
  return (val * sign);
 33a:	89 f0                	mov    %esi,%eax
 33c:	0f af c3             	imul   %ebx,%eax
}
 33f:	5b                   	pop    %ebx
 340:	5e                   	pop    %esi
 341:	5d                   	pop    %ebp
 ...
 519:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 555:	57                   	push   %edi
 556:	56                   	push   %esi
 557:	e8 47 fe ff ff       	call   3a3 <write>
 ...
 5ae:	e8 f0 fd ff ff       	call   3a3 <write>
        putc(fd, c);
 ...
 5bf:	57                   	push   %edi
 5c0:	56                   	push   %esi
 5c1:	e8 dd fd ff ff       	call   3a3 <write>
        putc(fd, c);
 ...
 62b:	57                   	push   %edi
 62c:	56                   	push   %esi
 62d:	e8 71 fd ff ff       	call   3a3 <write>
        while(*s != 0){
 ...
 66c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 66f:	e8 2f fd ff ff       	call   3a3 <write>
        ap++;
...
free(void *ap)
{
 ...
 6b1:	a1 e0 0d 00 00       	mov    0xde0,%eax
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	89 15 e0 0d 00 00    	mov    %edx,0xde0
}
 6f8:	5e                   	pop    %esi
 6f9:	5f                   	pop    %edi
 6fa:	5d                   	pop    %ebp
 ...
 729:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 72c:	89 15 e0 0d 00 00    	mov    %edx,0xde0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 3d e0 0d 00 00    	mov    0xde0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 4f                	jae    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	8b 3d e0 0d 00 00    	mov    0xde0,%edi
 ...
 7a3:	e8 63 fc ff ff       	call   40b <sbrk>
  if(p == (char*)-1)
 ...
 7ba:	e8 f1 fe ff ff       	call   6b0 <free>
  return freep;
 7bf:	8b 15 e0 0d 00 00    	mov    0xde0,%edx
 ...
 7ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7ef:	89 15 e0 0d 00 00    	mov    %edx,0xde0
}
 ...
 7ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 e0 0d 00 00 e4 	movl   $0xde4,0xde0
 807:	0d 00 00 
    base.s.size = 0;
 80a:	bf e4 0d 00 00       	mov    $0xde4,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 e4 0d 00 00 e4 	movl   $0xde4,0xde4
 816:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 81b:	c7 05 e8 0d 00 00 00 	movl   $0x0,0xde8
 822:	00 00 00 
    if(p->s.size >= nunits){
