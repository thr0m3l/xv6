 ...
 5f1:	a1 a8 0a 00 00       	mov    0xaa8,%eax
{
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 a8 0a 00 00    	mov    %edx,0xaa8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d a8 0a 00 00    	mov    0xaa8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 4f                	jae    720 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	8b 3d a8 0a 00 00    	mov    0xaa8,%edi
 ...
 6fa:	e8 f1 fe ff ff       	call   5f0 <free>
  return freep;
 6ff:	8b 15 a8 0a 00 00    	mov    0xaa8,%edx
 ...
 747:	0a 00 00 
    base.s.size = 0;
 74a:	bf ac 0a 00 00       	mov    $0xaac,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 b0 0a 00 00 00 	movl   $0x0,0xab0
 762:	00 00 00 
    if(p->s.size >= nunits){
