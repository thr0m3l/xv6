...
free(void *ap)
{
 ...
 601:	a1 e8 0a 00 00       	mov    0xae8,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 e8 0a 00 00    	mov    %edx,0xae8
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 e8 0a 00 00    	mov    %edx,0xae8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d e8 0a 00 00    	mov    0xae8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d e8 0a 00 00    	mov    0xae8,%edi
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 e8 0a 00 00    	mov    0xae8,%edx
 ...
 73c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 73f:	89 15 e8 0a 00 00    	mov    %edx,0xae8
}
 ...
 757:	0a 00 00 
    base.s.size = 0;
 75a:	bf ec 0a 00 00       	mov    $0xaec,%edi
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 ec 0a 00 00 ec 	movl   $0xaec,0xaec
 766:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 f0 0a 00 00 00 	movl   $0x0,0xaf0
 772:	00 00 00 
    if(p->s.size >= nunits){
